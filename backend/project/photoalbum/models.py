...
>>>>>>> 1f11a34 (created a Delete component check if album name already matches existing one same about if image headline matches then alert of name existing already)
    class Meta:
        ordering = ['headline']
